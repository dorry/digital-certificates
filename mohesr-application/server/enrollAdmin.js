...
async function main() {
    try {
        ...
        const caInfo = ccp.certificateAuthorities['n778465-mohesrca.mycluster2-344909-a2c3b56b240340230fd09eb15bebf412-0000.eu-gb.containers.appdomain.cloud:7054'];
        ...
        const identity = X509WalletMixin.createIdentity('mohesrmsp', enrollment.certificate, enrollment.key.toBytes());
